<template>
	<div class="white py-3">
        ...
        <div v-if="!loadedEventPlayersStatistics || loadedEventPlayersStatistics.length < 1">
            <h3 class="text-center">No player at the moment</h3>
        </div>
            ...
            <v-row no-gutters>
    			<v-col class="mx-2">
                    <v-row no-gutters justify="center" align="center">
                        <v-img :src="`/images/teams/${homeTeamSlug}.png`" max-width="80"></v-img>
                    </v-row>
                    <v-row no-gutters class="py-2">
                        <v-col cols="12">
                            ...
                            <v-row no-gutters class="lightgrey pa-1" v-for="(player, index) in loadedEventPlayersStatisticsHomeTeamGoalkeepers" :key="player.number">
                                <v-col cols="6">
                                    {{ player.player_name }} <span v-if="player.captain !== 'False'">(C)</span>
                                </v-col>
                                <v-col cols="2">
                                    {{ player.rating }}/10
                                </v-col>
                ...
                <v-col class="mx-2">
                    <v-row no-gutters justify="center" align="center">
                        <v-img :src="`/images/teams/${awayTeamSlug}.png`" max-width="80"></v-img>
                    </v-row>
                    <v-row no-gutters class="py-2">
                        <v-col cols="12">
                            <h3 class="py-1">Goalkeeper</h3>
